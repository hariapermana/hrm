                ...
                <div class="profile-modal d-none">
                    <div class="card">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/logout" onclick="closeProfileModal()">
                                    Logout
                                </a>
                            </li>
                        </ul>
    ...
    <section id="main" class="position-relative">
        <div class="container-fluid px-4 wrapper">
            <div class="card border-0">
                <div class="card-body">
                    <span>Welcome, <?= get_staff_full_name($current_user->staffid) ?>!</span>
                </div>
            </div>
            ...
            <div class="d-flex mt-3">
                ...
                <div class="flex-2">
                    ...
                    <ul>
                        <?php foreach($reminds as $i) : ?>
                        <li class="mt-2">
                            <a href="testing/inbox/<?= $i->uniq_code ?>">
                                <span>
                                    <b class="w500"><?= $i->subject ?></b> <br />
                    ...
                    <div class="go-to-inbox">
                        <a href="testing/inbox"> Go to Inbox </a>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex">
                        ...
                        foreach ($sidebar_menu as $key => $item) {
                            ...
                            if($item['name'] != 'Reminder' && $item['name'] != 'Customers') {
                        ?>
                            <div class="items">
