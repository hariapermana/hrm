...
<head>
    ...
    <title>Mid Year Evaluation - Overall Evaluation</title>
</head>
                            ...
                            <div class="card">
                                <div class="control-group after-add-more">
                                    <div id="collapse" class="collapse show" aria-labelledby="heading" data-parent="#accordion">
                                        <div class="card-body">
                                            <label for="succes_driver">Over all employee evaluation</label>
                                            <select name="overall_evaluation" class="form-control" id="overall_evaluation">
