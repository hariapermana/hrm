...
<head>
    ...
    <title>Mid Year Evaluation - Behavior</title>
</head>
                            ...
                            <div class="card">
                                <div class="control-group after-add-more">
                                    <div id="collapse" class="collapse show" aria-labelledby="heading" data-parent="#accordion">
                                        <div class="card-body">
                                            <label for="succes_driver">Success Driver</label>
                                            <textarea name="succes_driver[]" id="succes_driver" class="form-control"></textarea>

                                            <label for="criteria" class="mt-2">Criteria</label>
