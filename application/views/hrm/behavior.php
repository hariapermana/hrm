                ...
                <div class="card-body">
                    <div id="accordion">
                        <form action="">
                            <div class="card">
                                <div class="control-group after-add-more">
                                    ...
                                    <div id="collapse" class="collapse show" aria-labelledby="heading" data-parent="#accordion">
                                        <div class="card-body">
                                            <label for="sdriver">Succes Driver</label>
                                            <select name="sdriver" id="sdriver" class="form-control w-25">
                                                <option value="" class="text-center">-- Choose Driver --</option>
                                            </select>

                                            <label for="kpi" class="mt-2">Criteria</label>
                                            <textarea name="kpi[]" id="kpi" class="form-control"></textarea>

                                            <label for="weight" class="mt-2">Weight</label>
                                            <input type="text" class="form-control w-25" name="weight[]">

                                            <label for="status" class="mt-2" hidden>Status</label>
                                            <select name="status[]" class="form-control w-25" id="status" hidden>
                            ...
                            <a href="summary" class="btn btn-sm btn-warning ml-4 mt-4">Go to Summary</a>
                        </form>
