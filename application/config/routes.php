...
// Employee Routes
$route['admin/testing']   = 'admin/testing';
$route['admin/testing/inbox']   = 'admin/testing/inbox';
$route['admin/testing/inbox/(:any)']   = 'admin/testing/detail_inbox/$1';
$route['admin/testing/new-goals/(:any)']   = 'admin/testing/goals/$1';
$route['admin/testing/mid-year-evaluation/objective']   = 'admin/testing/midYearEvaluationObjective';
$route['admin/testing/mid-year-evaluation/behavior']   = 'admin/testing/midYearEvaluationBehavior';
$route['admin/testing/mid-year-evaluation/summary']   = 'admin/testing/midYearEvaluationSummary';
$route['admin/testing/final-annual-evaluation/objective']   = 'admin/testing/finalAnnualEvaluationObjective';
$route['admin/testing/final-annual-evaluation/behavior']   = 'admin/testing/finalAnnualEvaluationBehavior';
$route['admin/testing/final-annual-evaluation/overall-evaluation']   = 'admin/testing/finalAnnualEvaluationOverallEvaluation';
$route['admin/testing/final-annual-evaluation/summary']   = 'admin/testing/finalAnnualEvaluationSummary';
$route['admin/testing/behavior']   = 'admin/testing/behavior';
$route['admin/testing/objectives']   = 'admin/testing/objectives';
$route['admin/testing/staff']   = 'admin/testing/staff';
$route['admin/testing/reminder']   = 'admin/testing/reminder';
$route['admin/testing/performance_management']   = 'admin/testing/pmanagement';
$route['admin/testing/goals/(:any)']   = 'admin/testing/updateGoals/$1';
$route['admin/testing/summary/(:any)']   = 'admin/testing/updateSummary/$1';

// Manager Routes
$route['admin/home']   = 'admin/newpage';
$route['admin/home/inbox']   = 'admin/newpage/inbox';
$route['admin/home/inbox/(:num)/(:any)']   = 'admin/newpage/detailInbox/$1/$2';
$route['admin/home/performance']   = 'admin/newpage/performance';
$route['admin/home/reminder']   = 'admin/newreminder';
$route['admin/home/reminder/get-data']   = 'admin/newreminder/get_data_reminder';

// Api Routes
$route['api/goals_api']['POST'] = 'admin/goals_api/index_post';
$route['api/reminders_api']['POST'] = 'admin/reminders_api/index_post';
$route['api/summary_api']['POST']   = 'admin/summary_api/index_post';
$route['api/summary_api']['POST']   = 'admin/summary_api/index_post';
