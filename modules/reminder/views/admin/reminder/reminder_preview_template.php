                        ...
                        <table class="table text-left items">
                           ...
                           <tbody>
                              ...
                              <tr class="tax-area">
                                 ...
                                 <?php } ?>
                                 <?php if($reminder->rel_type=='Goals Settings'){ ?>
                                       <td class="bold">Reminder</td>
                                       <td>
                                     <?php echo $reminder->rel_type; ?>
                                          </a>
                                       </td>
                                 <?php } ?>
                        ...
                        <div class="panel_s">
                           <div class="panel-body">
                              <div class="row">
                                 ...
                                 <div class="col-md-6">
                                 <?php
                                 $value = (isset($reminderData) ? _d($reminderData->start_periode_date) : '');
                                 if($reminderData->is_complete=='0')
                                    {?>
                                       <?php echo render_date_input('start_periode_date','From_Date',$value,array('data-date-min-date'=>_d(date('Y-m-d')),'disabled'=>true) ); 
                                    }else{
                                       echo render_date_input('start_periode_date','From_Date',$value,array('data-date-min-date'=>_d(date('Y-m-d'))) ); 
                                    }
                                    ?>
                                 </div>
                                 <div class="col-md-6">
                                 <?php
                                 $value = (isset($reminderData) ? _d($reminderData->end_periode_date) : '');
                                 if($reminderData->is_complete=='0')
                                    {?>
                                       <?php echo render_date_input('end_periode_date','To_Date',$value,array('data-date-min-date'=>_d(date('Y-m-d')),'disabled'=>true) ); 
                                    }else{
                                       echo render_date_input('end_periode_date','To_Date',$value,array('data-date-min-date'=>_d(date('Y-m-d'))) ); 
                                    }
                                    ?>
                                 </div>
                                 <div class="col-md-12">
                                    <div class="row">
                                       <div class="col-md-12">
                                          <?php 
                                             ...
                                             $related = array(
                                                ['value'=>'Goals Settings',"rel_type" => _l('Goals Settings')],
                                                ['value'=>'Mid Year Evaluation',"rel_type" => _l('Mid Year Evaluation')],
                                                ['value'=>'End Year Evaluation',"rel_type" => _l('End Year Evaluation')],
