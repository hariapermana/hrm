...
class Reminder_model extends App_Model
{
	...
	{ 
		...
		$data['start_periode_date'] = $data['start_periode_date'];
		$data['end_periode_date'] = $data['end_periode_date'];
	...
	public function update($data, $id)
	{
		...
		$data['date'] = to_sql_date($data['date'], true);
		$data['start_periode_date'] = to_sql_date($data['start_periode_date'], true);
		$data['end_periode_date'] = to_sql_date($data['end_periode_date'], true);
