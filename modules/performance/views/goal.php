    ...
    <div class="content">
        <div class="row">
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <?php
                           ...
                           <div class="hide" id="subject">
                        <?php $subject = (isset($goal) ? $goal->subject : 'Goals'); ?>
                        <?php echo render_input('subject','Subject',$subject,'text',$attrs); ?>
                        </div>
                        <?php $value = (isset($goal) ? $goal->strategy : ''); ?>
                        <?php echo render_input('strategy','Sasaran Strategis',$value,'text',$attrs); ?>
                     
                        <?php $value = (isset($goal) ? $goal->description : ''); ?>
                        <?php echo render_textarea('description','Key Performance Indicators',$value); ?>
                        ...
                        <?php $value = (isset($goal) ? $goal->weight : ''); ?>
                        <?php echo render_input('weight','Bobot',$value,'number');?>
                        <?php $value = (isset($goal) ? $goal->target : ''); ?>
                        <?php echo render_input('target','Target',$value,'text');?>
                        <div class="hide" id="goal_start_date">
                        ...
                        <?php echo render_date_input('end_date','Due Date',$value); ?>
            ...
            if((isset($finished) && $goal->notified == 0) && ($goal->notify_when_achieve == 1 || $goal->notify_when_fail == 1)){
                ...
                echo '<div class="text-center"><a href="'.admin_url('performance/notify/'.$goal->id . '/'.$notify_type).'" class="btn btn-default">'._l('goal_notify_staff_manually').'</a></div>';
            }
            echo $help_text;
            ?>
